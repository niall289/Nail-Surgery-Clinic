  ...
  useEffect(() => {
    if (chatContainerRef.current) {
      ...
      if (lastMessage && lastMessage.type === "analysis") {
        setTimeout(() => {
          const analysisElements = chatContainerRef.current!.querySelectorAll(
            "[data-analysis-card]"
          );
          const lastAnalysisCard = analysisElements[
            analysisElements.length - 1
          ] as HTMLElement;
          if (lastAnalysisCard) {
            ...
            const targetScrollTop =
              currentScrollTop + cardTopRelativeToContainer - 10;
            container.scrollTo({
