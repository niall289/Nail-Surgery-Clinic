...
export function CalendarEmbed({
  ...
  return (
    <div className="w-full p-4 space-y-6">
      ...
      {/* Embedded Cliniko Booking Iframe */}
      <div className="relative bg-white rounded-lg shadow-md overflow-hidden w-full h-[600px] md:h-[750px]">
        <iframe
      ...
      <div className="flex justify-center">
        ...
        >
          ...
          {isLoading ? 'Processing...' : "✅ Done! I've completed my booking"}
        </button>
      </div>
    </div>
  );
